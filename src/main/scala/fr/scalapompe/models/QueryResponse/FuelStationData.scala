...
object FuelStationData {
  implicit val encoder: JsonEncoder[FuelStationData] = DeriveJsonEncoder.gen[FuelStationData]

  implicit val decoder: JsonDecoder[FuelStationData] = DeriveJsonDecoder.gen[FuelStationData]
}
